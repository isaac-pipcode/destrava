    ...
    <div className="animate-fade-in-up">
        ...
        {mode === 'selection' && (
             <div className="flex flex-col items-center justify-center min-h-[50vh] text-center">
                <h2 className="text-3xl font-display font-bold text-gray-900 mb-2">Diagnóstico Inteligente</h2>
                <p className="text-gray-500 mb-10 max-w-lg">Como você deseja realizar a análise financeira hoje?</p>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-3xl">
                    <button 
                        onClick={handleAnalyzeCurrentData}
                        className="bg-white p-8 rounded-3xl shadow-sm border-2 border-transparent hover:border-govblue hover:shadow-md transition-all group text-left"
                    >
                        <div className="w-14 h-14 bg-blue-50 rounded-full flex items-center justify-center mb-6 group-hover:bg-govblue group-hover:text-white transition-colors text-govblue">
                            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                        </div>
                        <h3 className="text-xl font-bold text-gray-800 mb-2">Analisar Meu Diário</h3>
                    ...
                    <button 
                         ...
                         className="bg-white p-8 rounded-3xl shadow-sm border-2 border-transparent hover:border-govorange hover:shadow-md transition-all group text-left"
                    >
                        <div className="w-14 h-14 bg-orange-50 rounded-full flex items-center justify-center mb-6 group-hover:bg-govorange group-hover:text-white transition-colors text-govorange">
                        ...
                        <h3 className="text-xl font-bold text-gray-800 mb-2">Enviar Planilha/Extrato</h3>
                        <p className="text-sm text-gray-500">
        ...
        {mode === 'upload' && !state.data && (
            <div className="max-w-xl mx-auto py-10">
                 <button onClick={() => setMode('selection')} className="text-gray-500 hover:text-govblue mb-4 flex items-center gap-2">
                    ← Voltar
                 </button>
                 <h2 className="text-2xl font-bold text-gray-900 mb-4 text-center">Upload de Arquivo</h2>
        ...
        {state.isLoading && mode === 'analysis' && (
            <div className="flex flex-col items-center justify-center min-h-[50vh]">
                 ...
                 <p className="text-lg text-gray-600 animate-pulse">A Inteligência Artificial está analisando suas finanças...</p>
            </div>
        )}
        ...
        {state.data && (
          <div className="animate-fade-in-up">
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold text-gray-800">Resultado do Diagnóstico</h2>
                <button 
                  onClick={handleReset}
                  className="px-4 py-2 bg-white border border-gray-300 rounded-md text-sm text-gray-700 hover:bg-gray-50 shadow-sm"
                >
                  Nova Análise
                </button>
            </div>

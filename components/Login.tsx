...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden border-t-8 border-govblue">
        <div className="p-8 text-center">
          ...
          <h1 className="text-2xl font-extrabold text-gray-800 mb-2">MAPA DA GESTÃO</h1>
          ...
          <div className="space-y-4">
            <button 
              onClick={onLogin}
              className="w-full py-3 px-4 bg-white border border-gray-300 rounded-full font-bold text-gray-700 hover:bg-gray-50 transition-all flex items-center justify-center gap-3 shadow-sm"
            >
